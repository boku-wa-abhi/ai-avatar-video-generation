"""
voice_gen.py — ElevenLabs TTS with automatic 16 kHz WAV conversion.

Generates speech audio from text using the ElevenLabs API (free tier),
then converts to 16 kHz mono WAV for downstream lip-sync models.
"""
...
class VoiceGenerator:
    """Text-to-speech wrapper around the ElevenLabs Python SDK."""
