...
# Ensure project root and src package are on sys.path.
...
def test_package_imports():
    ...
    assert "ROOT" in avatarpipeline.__all__
...
def test_face_enhancer_init():
    ...
    fe = FaceEnhancer()
    assert fe.backend in ("codeformer", "gfpgan", "gfpgan_subprocess", "passthrough")
...
def test_dashboard_import():
    """app.dashboard imports without error and exposes expected attributes."""
    import importlib
