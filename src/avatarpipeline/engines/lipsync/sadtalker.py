"""
avatarpipeline.engines.lipsync.sadtalker — SadTalker lip-sync inference wrapper.
...
from avatarpipeline import OUTPUT_DIR, ROOT
...
class SadTalkerInference:
    ...
    def __init__(self, preset: str = "sadtalker") -> None:
        ...
        self.sadtalker_dir = Path(os.path.expanduser(str(self.config.sadtalker_dir)))
        ...
        self.preset["expression_scale"] = self.config.expression_scale
