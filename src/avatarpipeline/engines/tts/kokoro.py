"""
avatarpipeline.engines.tts.kokoro — Local TTS using Kokoro (hexgrad/Kokoro-82M).
...
class VoiceGenerator:
    ...
    VOICES = {
        ...
        "jf_nezumi":     "jf_nezumi",      # soft narrative (The Mouse's Wedding)
        "jf_tebukuro":   "jf_tebukuro",    # gentle narrative (Buying Mittens)
        "jm_kumo":       "jm_kumo",
    }
    ...
    def __init__(self) -> None:
        ...
        cfg = load_config()
        self.default_voice = cfg.default_voice
        self.speed = cfg.tts_speed
        self.lang_code = cfg.tts_lang_code
